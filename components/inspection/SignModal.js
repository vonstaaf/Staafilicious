...
// WebView-canvas kräver explicit höjd. Lagom rityta – inte för hög modul.
const { width: screenWidth, height: screenHeight } = Dimensions.get("window");
const SIGNATURE_HEIGHT = Math.min(220, Math.max(200, Math.min(screenHeight, screenWidth) * 0.32));

// Tvingar inre canvas/body till full storlek så att ritning registreras (kan krävas i vissa WebViews/emulatorer).
const WEB_STYLE = `
